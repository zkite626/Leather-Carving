  ...
  const fetchArtworks = useCallback(
    async (pageNum: number, append = false) => {
      ...
      try {
        ...
        const res: PaginatedResponse<IArtwork> = await getArtworks(query) as PaginatedResponse<IArtwork>;
  ...
  return (
    <div className={styles.page}>
      <header className={styles.header}>
        <h1 className={styles.heading}>作品画廊</h1>
        <p className={styles.subtitle}>探索非遗皮雕艺术的魅力</p>
      </header>
