...
import { getBannersServer } from '@/lib/banner-api';
...
export default async function HomePage() {
  ...
  const [coursesRes, artworksRes, guangxiRes, hotProductsRes, bannersRes] = await Promise.allSettled([
