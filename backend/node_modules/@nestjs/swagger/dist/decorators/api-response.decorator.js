...
function ApiResponse(options, { overrideExisting } = { overrideExisting: true }) {
    ...
    const incomingEntry = (0, lodash_1.omit)(options, 'status');
    return (target, key, descriptor) => {
        if (descriptor) {
            ...
            Reflect.defineMetadata(constants_1.DECORATORS.API_RESPONSE, Object.assign(Object.assign({}, responses), { [statusKey]: mergeResponseEntry(responses === null || responses === void 0 ? void 0 : responses[statusKey], incomingEntry) }), descriptor.value);
            return descriptor;
        }
        ...
        Reflect.defineMetadata(constants_1.DECORATORS.API_RESPONSE, Object.assign(Object.assign({}, responses), { [statusKey]: mergeResponseEntry(responses === null || responses === void 0 ? void 0 : responses[statusKey], incomingEntry) }), target);
        return target;
    };
}
function mergeResponseEntry(existing, incoming) {
    ...
    const mergedExamples = existing.examples && incoming.examples
        ? Object.assign(Object.assign({}, existing.examples), incoming.examples) : (_a = incoming.examples) !== null && _a !== void 0 ? _a : existing.examples;
    return Object.assign(Object.assign(Object.assign(Object.assign({}, existing), incoming), { description: mergedDescription }), (mergedExamples !== undefined ? { examples: mergedExamples } : {}));
}
const decorators = {};
